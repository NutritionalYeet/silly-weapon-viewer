...
(6, 'Angry Cake', 'angry_cake.jpg', 'decent', 1, 4.50, 0, 1, 0, 5, 3, 0, 0, 0, 2, 2, 1, 5, '', 'Launches itself at a nearby foe, penetrating half defense. Violently explodes into frosting shrapnel on impact, dealing minor damage to all nearby entities.'),
(4001, 'Dimmy\'s Everyday Jester Hat', 'jester_hat.jpg', 'decent', 1, 1.83, 1, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, 'HOORAY EVERYDAY’S A GOOD DAY FOR	\r\nDIMMY AND HIS PALS IN A WINTER		\r\nWONDERLAND FILLED WITH CHOCOLATE	\r\nSHELLS', ''),
...
(7000, 'Debug Sword', NULL, 'debug', 1, 0.00, 0, 0, 0, 0, 10, 0, 0, 0, 5, 0, 0, 0, 'A sword for debugging purposes.', 'Use to slay bugs.'),
